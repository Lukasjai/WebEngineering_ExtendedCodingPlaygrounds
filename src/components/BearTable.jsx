...
const BearTable = () => {
    ...
    const createTableHeader = () => {
        const headers = ["Bear Type", "Coat", "Adult size", "Habitat", "Lifespan", "Diet"];
        return createElement(
            ...
            [
                createElement(
                    "tr",
                    {},
                    headers.map((header, index) => createElement("th", { key: index, scope: "col", style: { border: '1px solid black', padding: '8px', backgroundColor: '#ddddee' } }, [header]))
                )
            ]
        );
    };
    ...
    const createTable = () => {
        return createElement(
            ...
            [
                createElement("caption", { style: { marginBottom: '10px', fontWeight: 'bold' } }, [
    ...
    return createElement(
        "div",
        { className: "bear-table-section", style: { margin: '20px 0', padding: '20px', backgroundColor: '#b5d7a8', border: '1px solid #ccc', borderRadius: '8px' } },
        [
            createElement("h2", { style: { marginBottom: '10px' } }, ["Bear Characteristics"]),
            createTable(),
        ]
    );
};
